  ...
  return (
    <div className="relative w-full my-4 overflow-hidden">
      ...
      <div
        ...
        className="flex overflow-x-auto overflow-y-hidden scrollbar-hide py-6 snap-x snap-mandatory"
        style={{
          scrollbarWidth: "none",
      ...
      >
        {videos.map((video, index) => (
          <div key={video.id} className="flex-shrink-0 min-w-full flex justify-center items-center px-4 snap-center">
            ...
            <div
              className={`video-item w-full md:w-[85%] lg:w-[75%] xl:w-[65%] rounded-lg transition-all duration-800 relative ${
